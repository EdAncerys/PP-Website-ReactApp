export default {
  ...
  PP:
    "I've detailed some of my favorite projects, things I'm proud of, and all the skills I've developed since beginning to code. I'm always learning and evolving, faster than I can update my portfolio on the WebSite, so the best place to find out what I'm currently working on is my GitHub.",
  TickTackToe:
