          ...
          <div className="flex-container-90">
            <div>
              ...
              <div style={styles.paragraph}>
                ...
                and digital products. Enjoying challenges and don't shy away
                from time-consuming challenges that can deliver better results
                and continuous learning process it involves. Currently looking
                for opportunities to continue to learn, challenge myself, and
              ...
              <div style={styles.paragraph}>
                ...
                Learned best practices and methodologies: TDD, Agile
                development, XP values, team projects, code reviews, pair
                programming.
              </div>
            </div>
          </div>
